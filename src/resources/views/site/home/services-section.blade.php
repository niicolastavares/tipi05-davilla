<section class="services-section" style="background-image: url(https://via.placeholder.com/1920x1080);"> <!-- ! FEITO ! -->
                ...
                <div class="service-block">
                    <div class="inner-box">
                        <div class="image-box">
                            ...
                            <!-- cake img -->
                            <figure class="image"><img src="{{ asset('davilla/images/logo.png') }}" alt=""></figure>
                        </div>
