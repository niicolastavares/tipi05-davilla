        ...
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="portfolio-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box"><figure class="image"><img src="{{ asset('davilla/images/'. $linha->foto_produto) }}" alt=""></figure></div>
                        <div class="portfolio-hover">
                            ...
                            <a href="{{ route('cardapio.produto', $linha->slug_produto) }}" class="lightbox-image link" data-fancybox="portfolio"></a>
                            <h3>
                                <a href="{{ route('cardapio.produto', $linha->slug_produto) }}">{{ $linha->nome_produto }}</a>
                            </h3>
                        </div>
                    </div>
                </div>
