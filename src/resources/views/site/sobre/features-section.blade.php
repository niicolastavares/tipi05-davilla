@php
    $bannerFeatures = asset('davilla/images/sobre/banner-features.jpg');
@endphp

<div class="features-section style-two">
        <div class="shape_wrapper shape_one">
            <div class="shape_inner shape_two" style="background-image: url('{{ $bannerFeatures }}');"><div class="overlay"></div></div>
        </div>
