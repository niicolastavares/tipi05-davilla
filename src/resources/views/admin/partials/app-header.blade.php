<nav class="app-header navbar navbar-expand bg-body">
  ...
  <div class="container-fluid">
    ...
    <ul class="navbar-nav ms-auto">
      ...
      $fotoUser = $usuarioLogado && $usuarioLogado->foto ? asset('dash/assets/img/user/' . $usuarioLogado->foto) : asset('dash/assets/img/user/usernicolas.png');
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
          ...
          <li class="user-header text-bg-primary">
            ...
            <p>
              ...
              <br>
              <small>Funcionário desde {{ date('d/m/Y', strtotime($usuarioLogado->criado_em_usuario)) }}</small>
            </p>
          </li>
          <!--end::User Image-->
