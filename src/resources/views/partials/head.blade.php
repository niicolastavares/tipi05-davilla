<head>
    <meta charset="utf-8">
    <title>DaVilla: A Arte da Confeitaria</title>
    ...
    <link rel="shortcut icon" href="{{ asset('davilla/images/logo-davilla.svg') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('davilla/images/logo-davilla.svg') }}" type="image/x-icon">
